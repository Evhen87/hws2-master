...
export const filterAffairs = (affairs: AffairType[], filter: FilterType): AffairType[] => { // need to fix any
    if (filter === 'high') {
        affairs = affairs.filter((affairs) => affairs.priority === 'high')
    }
    if (filter === 'middle') {
        affairs = affairs.filter((affairs) => affairs.priority === 'middle')
    }
    if (filter === 'low') {
        affairs = affairs.filter((affairs) => affairs.priority === 'low')
    }
